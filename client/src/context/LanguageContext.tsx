...
export const translations: Translations = {
  ...
  navSeniorMembers: { en: 'Senior Members', kn: 'ಹಿರಿಯ ಸದಸ್ಯರು' },
  seniorMembers: { en: 'Senior Members', kn: 'ಹಿರಿಯ ಸದಸ್ಯರು' },
  generalMembers: { en: 'General Members', kn: 'ಸಾಮಾನ್ಯ ಸದಸ್ಯರು' },
